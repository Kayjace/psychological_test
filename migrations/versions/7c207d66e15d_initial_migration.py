...
Revision ID: 7c207d66e15d
Revises: 
Create Date: 2024-09-09 13:26:55.493297
...
def upgrade():
    ...
    sa.Column('option_1', sa.String(length=255), nullable=True),
    sa.Column('option_2', sa.String(length=255), nullable=True),
